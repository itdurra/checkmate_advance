      ...
      <div className='mx-auto max-w-5xl space-y-6 px-4 text-left text-sm text-white'>
        ...
        <CardRetroNoMotion className='space-y-4 p-4'>
          ...
          <p>
            ...
            services. I want to assure our mailing list subscribers that I will
            never sell or provide their information to third parties without
            their consent.
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              ...
              the User would like to unsubscribe from receiving future emails, I
