  ...
  return (
    <CardRetroNoMotion className='space-y-4 p-4'>
      ...
      <p>
        ...
        users (each, a “User”) of checkmateadvance.com. This policy applies to
        the Website and all products and services offered by Ian Durra Games
        LLC.
      </p>
      ...
      <p>
        ...
        promotions, and other information related to my products and services.
      </p>
      <p>
      ...
      <p>
        I do not sell or share your email address with unrelated third parties.
      ...
      <p>
        I use your browser&apos;s local storage to save gameplay progress and
        preferences. This data stays on your device and is not shared or
        transmitted to my servers. You can clear this data anytime through your
        browser settings.
      </p>
      ...
      <ul>
        <li>
          To run a promotion, contest, survey, or other Website feature: To send
          Users information they agreed to receive about topics I think will be
          of interest to them.
        </li>
        <li>
      ...
      <p>
        I adopt appropriate data collection, storage, and processing practices
        and security measures to protect against unauthorized access,
        alteration, disclosure, or destruction of your personal information
        stored on my Website or through trusted third-party services.
      </p>
      ...
      <p>
        I do not sell, trade, or rent Users’ personal identification information
        to others. However, I may share limited information (such as email
        addresses) with trusted third-party services like Mailchimp and
        Supabase, solely for the purpose of operating this Website and
        delivering email communications. These services are obligated to protect
        your data and use it only for the specific purposes described here.
      </p>
      ...
      <p>
        Ian Durra Games LLC has the discretion to update this privacy policy at
        any time. When I do, I will revise the updated date at the bottom of
        this page. I encourage Users to frequently check this page for any
        changes to stay informed about how I am helping to protect the personal
        information I collect. You acknowledge and agree that it is your
      ...
      <p>
        ...
        you do not agree to this policy, please do not use my Website. Your
      ...
      <p>
        ...
        this Website, or your dealings with this Website, please contact me at
        ian@checkmateadvance.com
      </p>
      <p>
